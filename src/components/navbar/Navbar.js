...
const Navbar = () => {
	...
	return (
		<nav className='navbar flex flex-wrap bg-[#ff5d5d] text-white relative z-20 overflow-hidden md:flex-row md:flex-nowrap md:justify-between md:px-10'>
			...
			<ul className='nav-link text-[18px] flex flex-col items-center space-y-2 pb-5 w-[100%] md:flex-row md:w-auto md:items-center md:pb-0 md:space-y-0'>
				<li>
					<a href='/#inicio' className='md:mr-3 hover:underline'>
						Inicio
					</a>
				</li>
				<li>
					<a href='#products' className='md:mr-3 hover:underline'>
						Productos
					</a>
				</li>
				<li>
					<a href='#offers' className='md:mr-3 hover:underline'>
						Ofertas
					</a>
				</li>
				<li>
					<a href='#about' className='md:mr-3 hover:underline'>
						About
					</a>
				</li>
				<li>
					<a href='#contact' className='md:mr-3 hover:underline'>
						Contacto
					</a>
				</li>
