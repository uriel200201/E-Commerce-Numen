...
const ShoppingCart = () => {
  ...
  return (
    <>
        <div className='dropdown-menu flex flex-col w-[285px] items-center absolute translate-y-[40px] pointer-events-none opacity-0 bg-white text-black p-1 rounded-[5px] shadow'>
